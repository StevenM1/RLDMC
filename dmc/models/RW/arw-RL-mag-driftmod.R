...
transform2.dmc <- function(pars, cvs, choiceIdx) {
  ...
  mean_v <- cbind((1+pars[1,,'driftMod'])*(pars[1,,"V0"] + pars[1,,"wV"]*(pars[2,,"SR"]-pars[1,,"SR"]) + pars[1,,'wS'] * (pars[2,,"SR"]+pars[1,,"SR"])),
                  (1+pars[2,,'driftMod'])*(pars[2,,"V0"] + pars[2,,"wV"]*(pars[1,,"SR"]-pars[2,,"SR"]) + pars[2,,'wS'] * (pars[2,,"SR"]+pars[1,,"SR"])))
