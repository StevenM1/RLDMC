...
transform2.dmc <- function(pars, cvs, choiceIdx) {
  ...
  mean_v <- cbind(pars[1,,"V0"] + pars[2,,"wV"]*log(pars['wB']*pars[2,,"SR"]),  # switch 1 and 2; 1 is 'correct' in updated, but 2 is 'correct' in response
                  pars[2,,"V0"] + pars[1,,"wV"]*log(pars['wB']*pars[1,,"SR"]))
