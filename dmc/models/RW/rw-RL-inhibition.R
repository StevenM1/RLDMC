...
transform2.dmc <- function(pars, cvs, choiceIdx) {
  ...
  mean_v <- cbind(pars[1,,"V0"] + pars[2,,"wV"]*pars[2,,"SR"] - pars[2,,'wI']*pars[1,,'SR'],  # switch 1 and 2; 1 is 'correct' in updated, but 2 is 'correct' in response
                  pars[2,,"V0"] + pars[1,,"wV"]*pars[1,,"SR"] - pars[1,,'wI']*pars[2,,'SR'])
