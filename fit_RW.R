...
# 
# par(mfrow=c(2,2))
# plot(0,0, type='n', xlim=range(meanV1OverTimeM$bin)+c(-.5, .5), ylim=c(0, 1), xlab='Bin', ylab='mean EV1')
...
#          col=ifelse(ease=="0.6", 1, ifelse(ease=="0.4", 2, ifelse(ease=="0.3", 4, 5))), pch=20, cex=.25)
#   
#   # toplot <- meanAccsOverTimeD[meanAccsOverTimeD$ease==ease,]
#   # lines(toplot$bin, 
#   #       toplot$acc, 
#   #       type='b',
#   #       col=ifelse(ease=="0.6", 1, ifelse(ease=="0.4", 2, ifelse(ease=="0.3", 4, 5))), pch=20, cex=.25)
