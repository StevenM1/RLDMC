...
dataName <- 'parameterRecovery-exp2'
...
samples <- loadSamples(fn='model-arw-RL-mag_data-exp2', samplesDir='samples')
...
save(allData, trueParameters, file = './parameterRecoveries/data/parameterRecovery-exp2.RData')
...
# # ## check fit
load('./parameterRecoveries/samples/model-arw-RL-mag_data-parameterRecovery-exp2.RData')
load('./parameterRecoveries/data/parameterRecovery-exp2.RData')
...
pdf(file='figures/exp2_parrec.pdf', width=6, height=4)
