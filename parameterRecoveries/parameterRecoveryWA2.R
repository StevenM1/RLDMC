...
# save(allData, trueParameters, file = './parameterRecoveries/data/parameterRecovery-expMultiAlternative2.RData')
# 
...
model <- model.dmc(p.map=list(A="1",t0="1",st0="1",s="1",
                   ...
                   type="norm")
load('./parameterRecoveries/data/parameterRecovery-expMultiAlternative2.RData')
...
source ("dmc/dmc.R")
source('utils.R')
load('./parameterRecoveries/samples/model-arw-RL-WA_data-parameterRecovery-expMultiAlternative2.RData')
load('./parameterRecoveries/data/parameterRecovery-expMultiAlternative2.RData')
