...
BPICDDMa <- getDataPpBPIC('ddm-RL-SAT-a-st0', 'exp3', BPIConly=TRUE)$BPIC
BPICDDMm <- getDataPpBPIC('ddm-RL-SAT-m-st0', 'exp3', BPIConly=TRUE)$BPIC
BPICDDMam <- getDataPpBPIC('ddm-RL-SAT-am-st0', 'exp3', BPIConly=TRUE)$BPIC

allBPICs <- cbind('DDM-a-st0'=BPICDDMa[,2],  
                  'DDM-m-st0'=BPICDDMm[,2], 
                  'DDM-am-st0'=BPICDDMam[,2])
...
if(savePlot) pdf('./figures/exp3-SAT-RLDDMst0.pdf', width=7, height=7/4*3)
